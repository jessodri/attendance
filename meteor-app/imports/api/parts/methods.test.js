...
if (Meteor.isServer) {
  ...
  describe('test method for marking up wholesale price', () => {
    it('should show retail price', () => {

      wholesalePrice = goodPart.wholesalePrice
      retailPrice = wholesalePrice * 3

      expect(retailPrice).to.equal(wholesalePrice * 3)
    })
  })
}